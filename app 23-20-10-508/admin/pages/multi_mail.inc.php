...
<?php
    if(isset($_POST['save'])){
        ...
        foreach ($results as $result){
    		...
    		$mail->Password='~Ix:9gJ~';
    		$mail->setFrom('info@gulfmexicooilplatform.com', 'Gulf Mexico Oil Platform');
    		$mail->addAddress($email);
    		$mail->addReplyTo('info@gulfmexicooilplatform.com', 'Gulf Mexico Oil Platform');
                    ...
                    <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; font-size: 14px; line-height: 1.5; color: #333333; background-color: #f9f9f9;">
                        <div style="width: 600px; margin: 20px auto; background: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                            ...
                            <div style="background: #1f332b; color: #ffffff; text-align: center; padding: 20px;">
                                <a href="#">
                                    <img src="https://gulfmexicooilplatform.com/wp-content/uploads/2021/11/ridgewood-energy-logo-400x60-1.svg" alt="Company Logo" style="width: 150px;">
                                </a>
                            </div>
                            <!-- Main Content -->
                            ...
                            <div style="background: #1f332b; color: #ffffff; padding: 20px; font-size: 12px; text-align: center;">
                                <p>Need help? Contact us at <a href="mailto:info@gulfmexicooilplatform.com" style="color: #ffffff; text-decoration: underline;">info@gulfmexicooilplatform.com</a><br>Available 24/7</p>
