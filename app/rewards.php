...
?>
				...
				<div class="container">
					<!--begin::Invoice-->
                    <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b bg-primary" style="height: 250px; background-image: url(theme/html/demo1/dist/assets/media/svg/patterns/taieri.svg)">
    <div class="card-body d-flex">
        <div class="d-flex py-5 flex-column align-items-start flex-grow-1">
            <div class="flex-grow-1">
                <a href="#" class="text-white font-weight-bolder font-size-h3">Referrals</a>
                <p class="text-white opacity-75 font-weight-bold mt-3">
                    <b>Total Referral Commission: $<?php echo number_format(($ref_com),2)?></b>
                </p>
                <p class="text-white opacity-75 font-weight-bold mt-3">
                    <b>Referral Link: https://gulfmexicooffshore.com/register?referral=<?php echo $code?></b>
                </p>
            </div>
            <a href="#" class="btn btn-link btn-link-white font-weight-bold">
                <b>Users Referred: </b> +<?php echo $whox?>
