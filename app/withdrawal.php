...
<div class="col-md-8">&nbsp;&nbsp;<h1 style="color: black;">WITHDRAWAL</h1>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<form class="deposit_form" action="withdraw_now" method="POST">
			<div class="modal-content">
				<div class="modal-body">
					<label>Amount (USD)</label>
					<input type="text" name="amount" value="" class="amount form-control" Placeholder="Enter withdrawal amount" required>
                    <br><label>Payment Address</label>
					<input type="text" name="address" value="" class=" form-control" Placeholder="Enter Payment Address" required>
					<br><p>Withdrawable Balance (USD): <strong id="usdt_balance"><?php echo number_format(($account), 2)?></strong></p>
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-primary font-weight-bold" name="btc_btn">Withdraw</button>
				</div>
			</div>
		</form>
	</div>
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<form action="withdraw_now" class='deposit_form' method="POST">
            
			<div class="modal-content">
				<div class="modal-body">
					<label>Amount (USD)</label>
                    
					<input type="text" id="amount" name="amount" value="" class="form-control" Placeholder="Enter withdrawal amount" required>
					<br><label>Payment Address (ERC-20)</label>
					<input type="text" name="address" value="" class=" form-control" Placeholder="Enter Payment Address" required>
					<br><p>Withdrawable Balance (USD): <strong id="usdt_balance"><?php echo number_format(($account), 2)?></strong></p>
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-primary font-weight-bold" name="eth_btn">Withdraw</button>
				</div>
			</div>
		</form>
	</div>
		...
		<form class="deposit_form" action="withdraw_now" method="POST">
			<div class="modal-content">
				<div class="modal-body">
					<label>Amount (USD)</label>
					<input type="text" name="amount" value="" class="amount form-control" Placeholder="Enter withdrawal amount" required>
					<br><label>Payment Address (TRC-20)</label>
					<input type="text" name="address" value="" class=" form-control" Placeholder="Enter Payment Address" required>
					<br><p>Withdrawable Balance (USD): <strong id="usdt_balance"><?php echo number_format(($account), 2)?></strong></p>
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-primary font-weight-bold" name="usdt_btn">Withdraw</button>
				</div>
			</div>
		</form>
	</div>
